  ...
  return (
    <div className="relative mt-32">
      ...
      justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24">
        <h6 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15">Freshness You Can Trust, Saving You will Love!</h6>
      ...
      <div className="flex items-center mt-6 font-medium">
        <Link
          ...
          className="group flex items-center gap-2 
             px-7 md:px-9 py-3 bg-blue-600 hover:bg-blue-700 
