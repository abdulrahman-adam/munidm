        ...
        <div className="hidden sm:block">
          {!user ? (
            <button
              ...
              className="px-6 py-2 bg-indigo-600 text-white rounded-full text-sm font-medium hover:bg-indigo-700 transition"
            >
              Connexion
            </button>
          ) : (
            <div className="relative group">
              ...
              <div className="hidden group-hover:block absolute right-0 top-full pt-2 w-40">
                <ul className="bg-white shadow-xl border border-gray-100 rounded-xl py-2 text-sm">
                  ...
                  <li
                    onClick={logout}
                    className="px-4 py-2 hover:bg-red-50 text-red-500 cursor-pointer transition border-t border-gray-50"
                  >
                    Déconnexion
                  </li>
                </ul>
